...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    private K getLoadingView(ViewGroup parent) {
        if (footerViewParent == null) {
            footerViewParent = getItemView(mLoadMoreView.getLayoutId(), parent);
            holder = createBaseViewHolder(footerViewParent);
        }
        // ImageView loadingImg = (ImageView) footerViewParent.findViewById(R.id.loading_img);
        // Glide.with(mContext).load(R.drawable.loading).into(loadingImg); // TODO 加载gif
    ...
    public void setUserSetPageSize(int userSetPageSize) {
        this.userSetPageSize = userSetPageSize;
    }
    ...
    private void autoLoadMore(int position) {
        ...
        if (position < getItemCount() - mPreLoadNumber || position < userSetPageSize - 1) {
            return;
        }
