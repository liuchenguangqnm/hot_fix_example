...
public class MultiDexLoader {
     ...
     */
    private static void expandFieldArray(Object instance, String fieldName, Object[] extraElements) throws
        ...
        // 先把从插件 apk 中获取的 element[] 复制到新数组里面，方便我们改进做热修复
    ...
    private static final class V19 {
        ...
        private static void install(ClassLoader loader, List<File> additionalClassPathEntries, File optimizedDirectory)
            ...
            expandFieldArray(dexPathList, "dexElements",
                    makeDexElements( /**  反射 宿主 apk 的 ClassLoader 的 pathList 成员变量（DexPathList类的）的 静态方法：
                             * makeDexElements 获得 Element[] 数组
                             * 这个数组的每一个元素都代表着被加载进来的 .dex 文件对象
                             */
                            dexPathList, new ArrayList<File>(additionalClassPathEntries), optimizedDirectory, suppressedExceptions));
         ...
         * @param files                存储 File 对象的 List ，内部的 File 指的是 插件 的存储全路径（在这里指的是资产目录的路径）
