...
public class DeviceCodeUtil {
    ...
    public static void getDeviceCodeCore() {
        ...
        if (androidID == null)
            androidID = "";
        machineModel = SystemPropertiesProxy.get(MyApplicationPlug.instance, "ro.product.model");
        cpuOS = SystemPropertiesProxy.get(MyApplicationPlug.instance, "ro.board.platform");
