...
public class NetUtil {
    ...
    public static boolean isNetworkConnected() {
        if (MyApplicationPlug.instance != null) {
            ConnectivityManager mConnectivityManager = (ConnectivityManager) MyApplicationPlug.instance
    ...
    public static boolean isWifiProxy() {
        ...
        if (IS_ICS_OR_LATER) {
            ...
            proxyAddress = android.net.Proxy.getHost(MyApplicationPlug.instance);
            proxyPort = android.net.Proxy.getPort(MyApplicationPlug.instance);
        }
