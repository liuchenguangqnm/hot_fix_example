package com.example.hotfix.utils.sunUi;
...
public class SunUiUtil {
    ...
    static {
        // 注册系统字体变化监听
        MyApplicationPlug.instance.registerComponentCallbacks(new ComponentCallbacks() {
            @Override
    ...
    public static void fixLayout(BaseActivity baseActivity) {
        ...
        DisplayMetrics activityDisplayMetrics = baseActivity.getResources().getDisplayMetrics();
    ...
    public static void fixLayout(BaseActivityFullScreen baseActivityFullScreen) {
        applicationDensityFix();
        DisplayMetrics activityDisplayMetrics = baseActivityFullScreen.getResources().getDisplayMetrics();
        if (realDensity != activityDisplayMetrics.density ||
                realDensityDpi != activityDisplayMetrics.densityDpi ||
                realScaledDensity != activityDisplayMetrics.scaledDensity) {
            activityDisplayMetrics.density = realDensity;
    ...
    public static void fixLayout(BaseFragmentActivity baseFragmentActivity) {
        applicationDensityFix();
        DisplayMetrics activityDisplayMetrics = baseFragmentActivity.getResources().getDisplayMetrics();
        if (realDensity != activityDisplayMetrics.density ||
                realDensityDpi != activityDisplayMetrics.densityDpi ||
                realScaledDensity != activityDisplayMetrics.scaledDensity) {
            activityDisplayMetrics.density = realDensity;
    ...
    public static void fixLayout(BaseFragment baseFragment) {
        applicationDensityFix();
        DisplayMetrics activityDisplayMetrics = baseFragment.getResources().getDisplayMetrics();
        if (realDensity != activityDisplayMetrics.density ||
                realDensityDpi != activityDisplayMetrics.densityDpi ||
                realScaledDensity != activityDisplayMetrics.scaledDensity) {
            activityDisplayMetrics.density = realDensity;
