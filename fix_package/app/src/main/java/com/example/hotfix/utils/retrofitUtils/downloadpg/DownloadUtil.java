...
public class DownloadUtil {
     ...
     * @param isInstallApk     下载的apk包是否需要安装
     * @return
     */
    public static boolean checkOrDownloadFinishFile(String totalUrl, int downLoadFileType, boolean isInstallApk) {
        if (totalUrl.equals(""))
            return false;
